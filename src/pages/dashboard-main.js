...
const DashboardMain = ({ isAuthenticated, candidates,finances,endorsements,companiesData }) => {
  useEffect(() => {
    if (!isAuthenticated) {
      Router.push("/");
    }
                    ...
                    <h5 className="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1">
                      <LazyLoad>
                        <span className="counter">
                          <CountUp duration={5} end={finances && finances.length} />
                        </span>
                      </LazyLoad>
                    </h5>
                ...
                >
                  ...
                  <div className="">
                    <h5 className="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1">
                      <LazyLoad>
                        <span className="counter">
                          <CountUp duration={3} end={candidates && candidates.length} />
                        </span>
                      </LazyLoad>
                    </h5>
                    <p className="font-size-4 font-weight-normal text-gray mb-0">
                ...
                >
                  ...
                  <div className="">
                    <h5 className="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1">
                      <LazyLoad>
                        <span className="counter">
                        <CountUp duration={3} end={endorsements && endorsements.length} />
                        </span>
                ...
                >
                  ...
                  <div className="">
                    <h5 className="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1">
                      <LazyLoad>
                        <span className="counter">
                        <CountUp duration={3} end={companiesData && companiesData.length} />
                        </span>
...
const mapStateToProps = (state) => ({
  ...
  candidates: state.product.products,
  endorsements: state.product.products,
  finances: state.product.products,
  companiesData: state.product.products,
});
